...
def backtest_view():
    ...
    return render_template(
        ...
        form={"instrument": _BT_INSTRUMENTS[0], "period": "60d",
              ...
              "f_retest": False, "f_adx": False, "f_tp": False, "f_ml": False,
              "trail_mult": 3.0})
...
def backtest_run():
    ...
    improved = f_htf2 or f_trail or f_strong or f_retest or f_adx or f_tp or f_ml
    ...
    form = {
        ...
        "f_retest": f_retest, "f_adx": f_adx, "f_tp": f_tp, "f_ml": f_ml,
